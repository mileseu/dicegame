...
Results:
I would have expected the results to be slightly higher given the expected value of each dice is 3.5 so 10.5 total without the special condition of flipping duplicates. The algorithm seems to score around this and I am struggling to understand why. 